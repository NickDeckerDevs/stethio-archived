...
<form action="" method="POST" id="payment-form" class="form-horizontal">
  ...
  <div class="paymentbg col-md-4 col-md-offset-4">
  <div class="page-header">
    <h2 class="gdfg">Pre-order Checkout</h2>
  </div>
  <noscript>
...
?>
  ...
  <fieldset>
  <legend>Number of devices</legend>
  <!-- Quantity -->
    <div class="form-group">
      <label class="col-sm-4 control-label" for="textinput">Quantity</label>
      <div class="col-sm-3">
        <input type="text" id="quantity" placeholder="1" maxlength="4" class="quantity form-control">
      </div>
    </div>
  ...
  <fieldset>
    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        <p>Your card will be charged $300.54 after you submit.</p>
    ...
    <div class="control-group">
      <div class="controls">
        <center>
          <button class="button greenbg orderhover mtb paynow" type="submit">Pay Now</button>
        </center>
      </div>
    </div>
  </fieldset>
